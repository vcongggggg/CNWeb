                                            ...
                                            <ul class="dropdown-menu">
                                                <c:if test="${sessionScope.user.role == 'admin'}">
                                                    <li><a class="dropdown-item"
                                                            href="${pageContext.request.contextPath}/user/admin/users">Quản
                                                            lý người dùng</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="${pageContext.request.contextPath}/product/admin/products">Quản
                                                            lý sản phẩm</a></li>
                                                </c:if>
                                                <li><a class="dropdown-item"
                            ...
                            <div class="col-md-6">
                                ...
                                <c:if test="${empty sessionScope.user}">
                                    <div class="alert alert-info">
                                        ...
                                        Vui lòng <a href="${pageContext.request.contextPath}/login.jsp">đăng nhập</a> để
                                        mua hàng
                                    </div>
                                </c:if>
                            </div>
