            ...
            <body>
                ...
                <div class="container my-5">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="${pageContext.request.contextPath}/admin/pending-products"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <select class="form-select" name="brand" onchange="this.form.submit()">
                                    ...
                                    <option value="Samsung" ${param.brand=='Samsung' ? 'selected' : '' }>Samsung
                                    </option>
                            ...
                            <div class="col-md-2">
                                <select class="form-select" name="status" onchange="this.form.submit()">
                                    ...
                                    <option value="in_stock" ${param.status=='in_stock' ? 'selected' : '' }>Còn hàng
                                    </option>
                                    <option value="out_of_stock" ${param.status=='out_of_stock' ? 'selected' : '' }>Hết
                                        hàng</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link"
                                        href="?page=${currentPage - 1}&search=${param.search}&category=${param.category}&brand=${param.brand}&status=${param.status}">Trước</a>
                                </li>
                                <c:forEach var="i" begin="1" end="${totalPages}">
                                    <li class="page-item ${currentPage == i ? 'active' : ''}">
                                        <a class="page-link"
                                            href="?page=${i}&search=${param.search}&category=${param.category}&brand=${param.brand}&status=${param.status}">${i}</a>
                                    </li>
                                </c:forEach>
                                <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                    <a class="page-link"
                                        href="?page=${currentPage + 1}&search=${param.search}&category=${param.category}&brand=${param.brand}&status=${param.status}">Sau</a>
                                </li>
                            </ul>
                        </nav>
                    </c:if>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label for="editImageUrl" class="form-label">Hoặc URL hình ảnh
                                                    mới</label>
