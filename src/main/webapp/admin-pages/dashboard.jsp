                ...
                <div class="container mt-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><i class="fas fa-chart-bar me-2"></i>Thống kê chi tiết
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <a href="${pageContext.request.contextPath}/admin/product-stats"
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <a href="${pageContext.request.contextPath}/admin/category-stats"
                                    ...
                                    <div class="list-group list-group-flush">
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <small class="text-muted">${pendingProducts} sản phẩm cần xem
                                                    xét</small>
                                            </div>
                                        ...
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <small class="text-muted">${totalUsers} người dùng trong hệ
                                                    thống</small>
                                            </div>
