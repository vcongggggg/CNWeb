                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ${empty totalProducts ? '0' : totalProducts}
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ${empty pendingOrders ? '0' : pendingOrders}
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                            Tổng doanh thu</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ${empty totalRevenue ? '0' : String.format("%,.0f", totalRevenue)} VNĐ
                                        </div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="list-group">
                                    <a href="${pageContext.request.contextPath}/stats/products"
                                        class="list-group-item list-group-item-action">
                                        <i class="fas fa-chart-pie"></i> Thống kê sản phẩm
                                    </a>
                                    <a href="${pageContext.request.contextPath}/stats/orders"
                                        class="list-group-item list-group-item-action">
                                        <i class="fas fa-chart-line"></i> Thống kê đơn hàng
                                    </a>
                                    <a href="${pageContext.request.contextPath}/stats/category"
                                        class="list-group-item list-group-item-action">
