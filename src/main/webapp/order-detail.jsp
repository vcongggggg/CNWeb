                                ...
                                <c:if test="${not empty sessionScope.user}">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active"
                                            href="${pageContext.request.contextPath}/order/list">Đơn hàng</a>
                                    </li>
                                </c:if>
                            </ul>
                            <ul class="navbar-nav">
                                        ...
                                        <div class="row">
                                            ...
                                            <c:choose>
                                                <c:when test=" ${order.status=='pending' }">bg-warning</c:when>
                                                        ...
                                                        <c:when test="${order.status == 'delivered'}">bg-success
                                                        </c:when>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${order.status == 'shipped'}">Đang giao
                                                            </c:when>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${empty orderItems}">
                                            <div class="alert alert-info">
                                                <i class="fas fa-info-circle"></i> Không có sản phẩm nào trong đơn hàng
                                                này.
                                            </div>
                                        </c:if>
                                    </div>
