                                        ...
                                        <div class="text-center">
                                            <span class="badge 
                                                <c:choose>
                                                    ...
                                                    <c:when test="${product.status == 'approved'}">bg-success</c:when>
                                                    <c:when test="${product.status == 'rejected'}">bg-danger</c:when>
                                                    <c:otherwise>bg-secondary</c:otherwise>
                                                </c:choose>">
                                                <c:choose>
                                                    <c:when test="${product.status == 'pending'}">Chờ duyệt</c:when>
                                                    <c:when test="${product.status == 'approved'}">Đã duyệt</c:when>
                                                    <c:when test="${product.status == 'rejected'}">Bị từ chối</c:when>
