                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item active"
                                                        href="${pageContext.request.contextPath}/product/my-products">Sản
                                                        phẩm của tôi</a></li>
                                                <li><a class="dropdown-item"
                                            ...
                                            <div class="card h-100 shadow-sm">
                                                ...
                                                <c:choose>
                                                    <c:when test=" ${product.status=='pending' }">bg-warning</c:when>
                                                            <c:when test="${product.status == 'approved'}">bg-success
                                                            </c:when>
                                                            <c:when test="${product.status == 'rejected'}">bg-danger
                                                            </c:when>
                                                            <c:otherwise>bg-secondary</c:otherwise>
                                                            </c:choose>">
                                                            <c:choose>
                                                                <c:when test="${product.status == 'pending'}">Chờ duyệt
                                                                </c:when>
                                                                <c:when test="${product.status == 'approved'}">Đã duyệt
                                                                </c:when>
                                                                <c:when test="${product.status == 'rejected'}">Bị từ
                                                                    chối</c:when>
