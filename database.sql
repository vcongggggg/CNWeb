...
('iPhone 13 Pro', 'iPhone', 'iPhone 13 Pro với chip A15 Bionic, camera 12MP, màn hình 6.1 inch', 17990000, 5, 'https://example.com/iphone13pro.jpg', 'iPhone', 2, 'Đã sử dụng', '6 tháng', 'Hà Nội', 'customer1@email.com', 'pending'),
('Samsung Galaxy S23', 'Samsung', 'Samsung Galaxy S23 với camera 50MP, chip Snapdragon 8 Gen 2', 15990000, 3, 'https://example.com/s23.jpg', 'Samsung', 2, 'Đã sử dụng', '6 tháng', 'Hà Nội', 'customer1@email.com', 'pending'),
('Xiaomi 13T Pro', 'Xiaomi', 'Xiaomi 13T Pro với camera Leica, chip MediaTek Dimensity 9200+', 12990000, 7, 'https://example.com/xiaomi13t.jpg', 'Xiaomi', 3, 'Mới', '12 tháng', 'Đà Nẵng', 'customer2@email.com', 'pending'),
('OPPO Find X6 Pro', 'Oppo', 'OPPO Find X6 Pro với camera Hasselblad, chip Snapdragon 8+ Gen 1', 13990000, 4, 'https://example.com/findx6.jpg', 'Oppo', 3, 'Đã sử dụng', '6 tháng', 'Đà Nẵng', 'customer2@email.com', 'pending'); 